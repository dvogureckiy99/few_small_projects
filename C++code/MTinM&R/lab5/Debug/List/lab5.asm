...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _impulseWidth=R4
	.DEF _impulseWidth_msb=R5
...
; .FSTART _extIntIsr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 000E     // Если высокий уровень на ножке, то
; 0000 000F     // это начало импульса
; 0000 0010     if(BIT_IS_SET(PINE, 7))
	SBIS 0x1,7
	RJMP _0x1B
; 0000 0011     {
; 0000 0012         // Обнуляем счётный регистр таймера №3
; 0000 0013         TCNT3H = 0;
	LDI  R30,LOW(0)
	STS  137,R30
; 0000 0014         TCNT3L = 0;
...
; 0000 0017     {
; 0000 0018 
; 0000 0019         // Если низкий уровень на ножке, то
; 0000 001A         // это конец импульса
; 0000 001B         // Сохраняем текущее значение счётного регистра
; 0000 001C         // таймера №3
; 0000 001D         impulseWidth = TCNT3L;         //tick
	LDS  R4,136
	CLR  R5
; 0000 001E         impulseWidth += (TCNT3H) << 8; //tick
	LDS  R30,137
	MOV  R31,R30
	LDI  R30,0
	__ADDWRR 4,5,30,31
...
_main:
; .FSTART _main
; 0000 0024     unsigned int length;
; 0000 0025 
; 0000 0026     init_segments();
;	length -> R16,R17
	RCALL _init_segments
; 0000 0027     DDRE = _BV(DDE6);
	LDI  R30,LOW(64)
	OUT  0x2,R30
; 0000 0028 
; 0000 0029     EICRB = _BV(ISC70) ;//на оба
	OUT  0x3A,R30
; 0000 002A     EIMSK = _BV(INT7);
	LDI  R30,LOW(128)
	OUT  0x39,R30
; 0000 002B     #asm("sei");  //разрешение прерываний
	sei
; 0000 002C 
; 0000 002D     // Инициализация таймера №3
; 0000 002E     TCCR3B =  _BV(CS31);    //freq=11.0529/8=1.382 MHz T=724 ns/tick
	LDI  R30,LOW(2)
	STS  138,R30
; 0000 002F 
; 0000 0030     while(1)
_0x1D:
; 0000 0031     {
; 0000 0032         length =impulseWidth*prop; //cm
	MOVW R30,R4
	LDI  R26,LOW(3)
	LDI  R27,HIGH(3)
	CALL __MULW12U
	...
	CALL __DIVW21U
	MOVW R16,R30
; 0000 0033         BitSet(PORTE,DDE6);
	SBI  0x3,6
; 0000 0034         delay_us(10);
	__DELAY_USB 37
; 0000 0035         BitClr(PORTE,DDE6);
	CBI  0x3,6
; 0000 0036         delay_ms(50);
	LDI  R26,LOW(50)
	LDI  R27,0
	CALL _delay_ms
; 0000 0037 
; 0000 0038         indic_uint(length);
	MOVW R26,R16
	RCALL _indic_uint
; 0000 0039     }
	RJMP _0x1D

...
Частота 700 гц, отсюда период 1429 мксек
...
TIME_DASH DELAY_BETWEEN_CHARACTERS TIME_DOT DELAY_BETWEEN_LETTERS TIME_DOT DELAY_BETWEEN_CHARACTERS TIME_DOT DELAY_BETWEEN_WORDS TIME_DOT DELAY_BETWEEN_CHARACTERS
...
#define OUTPUT_STRING "MY NAME IS VICTOR" //Выводимая строка 

#define HALF_PERIOD 714 // Т/2 в мксек
         ...
         {     
...

            {
...

                {
                     ...
                     PORTE |= 1; //зажигаем светодиод красным цветом

...
#define Time_1 10  // начальное время задержки в мсек
#define Time_step 500 //время через которое изменяется задержка в мсек
#define STEP_ENGINE 1 //шаг изменение времени задержки в мсек
#define time_pause 3000 // время между переключением направления двигателя (мс)
#define Time_2 2 // конечное время задержки в мсек
